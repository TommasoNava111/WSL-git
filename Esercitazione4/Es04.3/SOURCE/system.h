...
private:
  ...
  //AGGIUNTO
  string _outputTag; // Tag per distinguere i file di output
...
public: // Function declarations
  ...
  void setOutputTag(const std::string& tag) { _outputTag = tag; }
  string getOutputTag() const { return _outputTag; }
